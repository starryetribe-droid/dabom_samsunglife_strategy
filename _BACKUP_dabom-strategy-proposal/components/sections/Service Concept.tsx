...
export const ServiceConcept: React.FC = () => {
  return (
    <SectionWrapper id="service-concept" className="bg-white">
      <div className="max-w-7xl mx-auto px-6 w-full">
        ...
        <div className="text-center mb-16">
          <FadeIn>
            <span className="text-monimo-blue font-bold tracking-wider text-sm uppercase mb-2 block">Service Concept</span>
            <h2 className="text-3xl md:text-5xl font-extrabold text-monimo-black">AI 라이프 케어 메이트</h2>
            <p className="text-monimo-gray font-medium mt-4 text-lg">초개인화된 데이터로 먼저 다가가는 능동형 케어</p>
          </FadeIn>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <FadeIn className="order-2 lg:order-1">
            <div className="mb-8">
              ...
              <p className="text-lg text-monimo-gray font-medium leading-relaxed mb-8 break-keep">
            ...
            <div className="space-y-4">
              <GlassCard className="p-4 flex items-center gap-4 border border-gray-100 hover:border-monimo-blue/30 transition-colors">
                <div className="w-12 h-12 rounded-2xl bg-blue-50 text-monimo-blue flex items-center justify-center text-xl shrink-0">
                  <i className="fa-solid fa-heart-pulse"></i>
                </div>
                <div>
                  <h4 className="font-bold text-monimo-black">초개인화 감성 케어</h4>
                  <p className="text-sm text-gray-500">삼성 헬스 데이터와 연동된 신체/정서 통합 분석</p>
                </div>
              </GlassCard>
              ...
              <GlassCard className="p-4 flex items-center gap-4 border border-gray-100 hover:border-monimo-blue/30 transition-colors">
                ...
                <div>
                  <h4 className="font-bold text-monimo-black">먼저 거는 대화 (Proactive)</h4>
                  <p className="text-sm text-gray-500">이상 징후 감지 시 먼저 안부를 묻는 능동적 개입</p>
                </div>
              </GlassCard>
              ...
              <GlassCard className="p-4 flex items-center gap-4 border border-gray-100 hover:border-monimo-blue/30 transition-colors">
                ...
                <div>
                  <h4 className="font-bold text-monimo-black">Brain Fitness 연동</h4>
                  <p className="text-sm text-gray-500">대화 속에서 자연스럽게 이어지는 인지 강화 훈련</p>
                </div>
              </GlassCard>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={200} className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative w-[300px] md:w-[340px] h-[600px] md:h-[640px] bg-white rounded-[3rem] border-8 border-gray-100 shadow-2xl overflow-hidden ring-1 ring-gray-200">
              ...
              <div className="absolute top-0 w-full h-8 bg-white z-20 flex justify-between items-center px-6 pt-2">
                ...
                <div className="flex gap-1 text-gray-800 text-[10px]">
              ...
              <div className="absolute top-8 w-full h-14 bg-white/80 backdrop-blur-sm z-10 flex items-center justify-between px-6 border-b border-gray-50">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-bold text-monimo-black">AI 다봄</span>
                </div>
              ...
              <div className="w-full h-full bg-[#F5F7F9] pt-24 px-4 pb-20 overflow-y-auto no-scrollbar flex flex-col gap-4">
                ...
                <div className="flex justify-center my-2">
                  <span className="text-[10px] text-gray-400 bg-gray-200/50 px-3 py-1 rounded-full">2025년 12월 22일 월요일</span>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col gap-1 max-w-[80%]">
                    ...
                    <div className="bg-white p-3.5 rounded-2xl rounded-tl-none shadow-sm text-sm text-gray-800 leading-relaxed border border-gray-100">
                      좋은 아침이에요, 김삼성님! ☀️<br/>
                      어젯밤에는 <span className="text-monimo-blue font-bold">수면 시간이 평소보다 2시간 적으셨네요.</span> 몸은 좀 어떠세요?
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-row-reverse gap-3">
                   <div className="flex flex-col gap-1 max-w-[80%] items-end">
                    <div className="bg-monimo-blue p-3.5 rounded-2xl rounded-tr-none shadow-sm text-sm text-white leading-relaxed">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="flex flex-col gap-1 max-w-[85%]">
                    ...
                    <div className="mt-1 flex gap-2">
                        <button className="bg-white border border-monimo-blue text-monimo-blue text-xs font-bold px-4 py-2 rounded-full shadow-sm hover:bg-blue-50 transition">
                            스트레칭 영상 보기
                        </button>
                    </div>
                  </div>
                 ...
                 <div className="flex gap-3 mt-2">
                    <div className="w-8 h-8 rounded-full bg-monimo-blue/20 shrink-0 flex items-center justify-center text-monimo-blue text-xs shadow-sm">
                        <div className="flex gap-0.5">
                            <div className="w-1 h-1 bg-monimo-blue rounded-full animate-bounce"></div>
                            <div className="w-1 h-1 bg-monimo-blue rounded-full animate-bounce" style={{animationDelay: '0.1s'}}></div>
                            <div className="w-1 h-1 bg-monimo-blue rounded-full animate-bounce" style={{animationDelay: '0.2s'}}></div>
                        </div>
                    </div>
                 </div>
              ...
              <div className="absolute bottom-0 w-full h-20 bg-white border-t border-gray-100 px-4 flex items-center gap-3">
                ...
                <div className="flex-1 h-10 bg-gray-50 rounded-full border border-gray-200 flex items-center px-4 text-sm text-gray-400">
                  대화를 입력하세요...
                </div>
