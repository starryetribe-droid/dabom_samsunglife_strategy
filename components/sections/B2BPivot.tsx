                        ...
                        <div className="bg-white rounded-[1.5rem] p-5 shadow-lg border border-gray-100">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <div className="flex flex-col md:flex-row md:items-baseline md:gap-3">
                                    <h3 className="text-[18px] font-bold text-gray-900">1. 인지훈련 패러다임 전환</h3>
                            ...
                            <p className="text-gray-600 mb-4 ml-0 md:ml-14 text-[15px] leading-snug">
                                고령층 타겟의 무거운 이미지를 벗고, 임직원의 업무 효율 극대화를 위한 <span className="font-bold text-gray-900">고성능 솔루션</span>으로 리브랜딩합니다.
                            </p>
